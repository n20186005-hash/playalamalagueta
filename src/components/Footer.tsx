          ...
          <div className="max-w-md">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://www.andalucia.org/" target="_blank" rel="noopener noreferrer" className="hover:underline text-sm" style={{ color: 'var(--accent)' }}>
                {t('officialLinks.andalusiaTourism')}
              </a>
              <a href="https://visita.malaga.eu/es/" target="_blank" rel="noopener noreferrer" className="hover:underline text-sm" style={{ color: 'var(--accent)' }}>
                {t('officialLinks.malagaTourism')}
              </a>
              <a href="https://guiadigital.iaph.es/" target="_blank" rel="noopener noreferrer" className="hover:underline text-sm" style={{ color: 'var(--accent)' }}>
                {t('officialLinks.andalusiaHeritage')}
              </a>
              <a href="https://sig.mapama.gob.es/geoportal/" target="_blank" rel="noopener noreferrer" className="hover:underline text-sm" style={{ color: 'var(--accent)' }}>
                {t('officialLinks.beachGuide')}
              </a>
              <a href="https://datos.gob.es/es/aplicaciones/guia-de-playas" target="_blank" rel="noopener noreferrer" className="hover:underline text-sm" style={{ color: 'var(--accent)' }}>
                {t('officialLinks.openData')}
              </a>
            </div>
          </div>
