...
export default function LanguageToggle() {
  ...
  function switchLocale(next: Locale) {
    ...
    // Use next-intl router to properly switch locale
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-[0.375rem] px-3 py-[0.375rem] rounded-md text-sm font-medium transition-colors"
        style={{
        ...
        >
          {routing.locales.map((loc) => (
            <button
              ...
              className="w-full text-left px-4 py-[0.625rem] text-sm transition-colors"
              style={{
